...
const Footer = () => {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20 font-foundersGrotesk">
        <div className="w-1/2 flex flex-col h-full justify-between ">
           <div className="headings">
                ...
                <h1 className="text-[8vw] font-semibold uppercase leading-none -mb-4">Opening</h1>
           </div>
